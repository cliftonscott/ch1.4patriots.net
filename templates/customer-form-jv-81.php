...
//REMOVE WHEN CONTROL IS ACHEIVED
	...
	<div class="form-container" id="formcheck">
		...
		<form role="form" action="<?php echo url('/checkout/process.php'); ?>" method="post" accept-charset="utf-8" id="billing-form">
			...
			<div class="form-group zip-contain">
				...
				<input type="text" class="form-control zip-field" id="billing-zip" name="billing-zip" value="<?php echo $preFill['billing-zip'];?>" data-validate-min="5" data-validate-max="7" maxlength="7">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="creditCardNumber" name="creditCardNumber" value="" data-validate-min="13" data-validate-max="20">
			</div>
			...
			<div class="form-group card-cvv2-contain">
				...
				<input type="text" class="form-control cvv2-field" id="card-cvv2" name="card-cvv2" value="" data-validate-min="3" data-validate-max="4">
			</div>
	...
	<script>
		...
		/*
		 Init checkout form validation jquery.form-validation.js
		 */
		(function($){
			'use strict';
			$(function(){
				$('#billing-form').formValidate();
			});
		})(jQuery);
