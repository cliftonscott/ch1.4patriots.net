...
<div class="form-container" id="formcheck">
	<div id="secure-order-bar" class="text-center clearfix">
		<div class="pull-right"><i class="fa fa-lock" style="color:white; padding-right:12px;padding-top:7px;"></i></div>
		<div class="pull-left"><i class="fa fa-arrow-down" style="color:white; padding-left:12px;padding-top:6px;"></i></div>
