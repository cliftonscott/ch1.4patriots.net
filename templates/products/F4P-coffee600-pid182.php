...
?>
	...
	<div id="belcher-box" class="hidden-xs">
		...
		<div class="box-body">
			<div class="timer-box">
				<a id="fancybox-veggies" href="javascript:void();" onclick="showTimerModal();"><img src="/media/images/f4p/f4p-product-img-typ-coffee600-01.jpg" width="360" height="230" alt="3 Month Food Supply">
			...
			<p><span class="bold red"><strong>Click &ldquo;Add To Order&rdquo; button in the next 10 minutes</strong></span> and we&rsquo;ll add the Food4Patriots Coffee Kit to your order for just one additional payment of <strong>$97</strong>.</p>
...
<p>This offer is exclusive ONLY to Food4Patriots customers and it’s likely this will be the <span class="bold red">only time you see it at this special price.</span></p>
			<p>Believe it or not, coffee can be an amazing equalizer in a crisis… it provides a familiar routine and a sense of calm and focus, even when everything else could be swirling in chaos. Get your supply now, <strong>Click the &ldquo;Add To Order&rdquo;</strong> button below now:</p>
...
<div id="timerModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" style="width:700px;height:750px;">
		<div class="modal-content" style="background-image:url(/media/images/f4p/f4p-product-img-coffee600-01.jpg);background-size: 700px;background-repeat: no-repeat;background-position: bottom;">
			<div style="text-align:center;padding:10px;width:700px;height:440px;">
