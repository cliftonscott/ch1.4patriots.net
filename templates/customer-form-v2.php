				...
				<div style="background-color:#eeeeee;padding:0" class="col-xs-6 form-fw">
					...
					<div class='form-row'>
						<div class='col-xs-12 form-group card'>
							<label for="creditCardNumber">Card Number: <i class="fa fa-cc-mastercard"> <i class="fa fa-cc-visa"></i> <i class="fa fa-cc-discover"></i> </i> <i class="fa fa-cc-amex"></i></label>
					...
					<div class="row securtiy-seals">
						<div class="col-xs-6 col-sm-3"><a href="https://sealinfo.websecurity.norton.com/splash?form_file=fdf/splash.fdf&dn=secure.food4patriots.com&lang=en" target="_blank"><img class="norton" src="/assets/images/checkout/secure-seal-norton.png"></a></div>
						...
						<div class="col-xs-6 col-sm-3"><a href="https://www.mcafeesecure.com/verify?host=secure.food4patriots.com" target="_blank"><img class="mcafee" src="/assets/images/checkout/secure-seal-mcafee.png" alt="Trust Seals" style="margin-top: 6px;"></a></div>
					</div>
			</form>
		</div>
