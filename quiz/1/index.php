		...
		<div class="container oto-width">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<div id="start-quiz">
						<a href="quiz.php"><button class="start-btn" style="margin-top:8px; font-weight:bold;">Start The Quiz</button><br><p class="click-here" style="font-size: 20pt; padding-bottom: 10px;">(Click Here to Start The Quiz)</p></a>
					</div>
