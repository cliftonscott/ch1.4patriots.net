	...
	<div class="container-main">
		...
		<div class="container oto-width">
			...
			<div class="margin-tb-20">
				<p class="read-warning text-center "><strong>NOTE:</strong> Your credit card statement will show a charge from Food4Patriots.com and your bonuses are below</p>
			</div>
			<div class="margin-tb-20">
				<?php include("snippets/frank-thankyou-msg-fruitveggie.html");?>
			</div>

			<div class="margin-tb-20">
				<?php
				$testimonials = array("aeron", "michael", "rick",);
			...
			<div class="margin-tb-20">
				<?php include_once("products/F4P-protein-pid_number.php");?>
			</div>
