...
<div class="container oto-width">
  ...
  <div>
          <p><?php echo $firstName;?>,</p>
            <p>I&rsquo;d like to personally congratulate you on taking action and getting the state-of-the-art Patriot Power Generator 1500. You&rsquo;re going to absolutely love it and the peace of mind it will give you and your family. </p>
            ...
            <img class="img-responsive pull-left img-padding-right" src="/media/images/ppg/ppg-oto-warehouse-01.jpg"/>
    <p>A Patriot Power Generator 1500 has been reserved for you, and our team in the warehouse is already preparing it for shipment to your front door. In about 15 minutes, you&rsquo;ll get an email confirmation of your order details.</p>         
          ...
          <p>This isn&rsquo;t just about keeping the lights on or your cell phone charged...it&rsquo;s about survival in a crisis. </p>
            ...
            <p class="darkRed"><strong><em>How would you like to effectively DOUBLE THE POWER of your Patriot Power Generator 1500 by being able to charge it two times faster…PLUS protect your generator from a disastrous EMP attack? </em></strong></p>
    ...
    <img class="img-responsive pull-right img-padding-left" src="/media/images/ppg/ppg-oto-emp-01.jpg"/>
...
<div>
        <form action="/checkout/order.php" method="post" accept-charset="utf-8" id="optin-form2">
				<div class="text-center center-block">
					<input type="image" src="/assets/images/buttons/btn-orange-click-accept-01.jpg" name="submit" class=" img-responsive center-block" onClick="patriotTrack('no-payments-6-months');"/>
				</div>
				<input type="hidden" name="quantity" id="quantity" value="1">
                ...
                <div class="noThanks">
                <a href="/checkout/upgrade/ppg-platinum-payments.php" onclick="patriotTrack('no-thanks-link');">No Thanks</a> – I want to give up this opportunity.<br>
