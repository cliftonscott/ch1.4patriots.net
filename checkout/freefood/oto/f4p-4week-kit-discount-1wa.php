	...
	<div class="container-main">
		...
		<div class="container oto-width">
			...
			<div>
				...
				if($isUpgrade) {
					?>
					<p class="text-center"><a href="/order/<?php echo $productDataObj->productId;?>" title="Add to Order!"><img src="/assets/images/buttons/btn-orange-click-accept-01.jpg" alt="Add To Order!" class="img-responsive center-block" /><strong style="font-size: 20px;"><span class="darkRedStrike">Add To Cart - $397</span><br><u>Add To Cart - $147</u></strong></a></p>
					<?php
				} else {
					?>
					<p class="text-center"><a href="/checkout/process.php" title="Add to Order!"><img src="/assets/images/buttons/btn-orange-click-accept-01.jpg" alt="Add To Order!" class="img-responsive center-block" /><strong style="font-size: 20px;"><span class="darkRedStrike">Add To Cart - $397</span><br><u>Add To Cart - $147</u></strong></a></p>
