...
<div class="container oto-width">
        ...
        <div style="padding-bottom:20px;"><img class="img-responsive center-block"src="/media/images/f4p/f4p-3-month-kit-01.jpg" alt="Platinum Package"/></div>
		<div>
		...
		<div>
			<form action="/checkout/process.php" method="post" accept-charset="utf-8" id="optin-form2">
 			...
 			<div class="noThanks">
  				<a href="/checkout/thankyou.php" onClick="">No Thanks</a> – I want to give up this opportunity.<br>
