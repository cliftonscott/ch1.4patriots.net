	...
	<div class="container-main">
		...
		<div class="container oto-width">
			...
			<div>
				...
				if($isUpgrade) {
					?>
					<p class="text-center"><a href="<?php echo url("/order/" . $productDataObj->productId);?>" title="Add to Order!"><img src="/assets/images/buttons/btn-orange-click-accept-01.jpg" alt="Buy It Now!" class="img-responsive center-block" /></a></p>
					<p class="text-center"><i>Click the button above if <a href="<?php echo url("/order/" . $productDataObj->productId);?>" title="Add to Order!" onClick=""><u>you're ready to accept the special offer now</u></a>, or read the rest of the page below and accept or decline the offer at the bottom of the page.</i></p>
					<?php
				} else {
					?>
					<p class="text-center"><a href="<?php echo url("/checkout/process.php"); ?>" title="Add to Order!"><img src="/assets/images/buttons/btn-orange-click-accept-01.jpg" alt="Buy It Now!" class="img-responsive center-block" /></a></p>
				...
				<p><?php echo $firstName;?>, this is your last chance for this special one-time discount, so you need to act now. To get another 4-week Food4Patriots kit at $50.00 less than everybody else pays (that&rsquo;s 25% off), click the big orange &ldquo;Click To Accept&rdquo; button below.</p>
				<div>
					<?php
					if($isUpgrade) {
						?>
					...
					<div class="noThanks">
						<a href="<?php echo url('/checkout/oto/f4p-seeds-rutgers.php'); ?>">No Thanks</a> – I want to give up this opportunity. I understand that I will not receive this special offer again.
					</div>
				</div>
			</div>
		</div>
