...
<div class="container-main">
	...
	<div class="container oto-width">
			...
			<div style="padding-bottom:20px;"><img class="img-responsive center-block"src="/media/images/ss4p/ss4p-lsv-bogo-01.jpg" alt="Liberty Seed Vaults"/></div>
			...
			<div>
				...
				<div class="text-center center-block"> <a href="<?php echo url("/checkout/process.php"); ?>"><img src="/assets/images/buttons/btn-orange-click-accept-01.jpg" class="img-responsive center-block"/></a></div>
