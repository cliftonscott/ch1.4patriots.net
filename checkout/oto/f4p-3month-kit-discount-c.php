...
?>
			...
			<div class="noThanks">
				<a href="/checkout/oto/f4p-4week-kit-discount-c.php" onClick="patriotTrack('no-thanks-link');">No Thanks</a> – I want to give up this opportunity. I understand that I will not receive this special offer again.
			</div>
		</div>
	</div>
