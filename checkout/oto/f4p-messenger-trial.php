...
<div class="container oto-width">
	...
	<div>
	  ...
	  <div class="noThanks">
		<a href="<?php echo url('/checkout/thankyou.php'); ?>">No Thanks</a> – I want to give up this opportunity. I understand that I will not receive this special offer again.
			</div>
