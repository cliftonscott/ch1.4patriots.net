...
switch ($prevProduct) {
	case 277:
		...
		$AddProduct= "1 month";
		$AddProductTitle= "An Additional <br> 1-Month";
		$ProductImage = '<img class="img-responsive center-block"src="/media/images/f4p/f4p-4-week-kit-04.jpg" alt="4 Week Food4Patriots Kit"/>';
		break;
	case 278:
	...
	default:
		...
		$PrevProductTime = "4-week";
		$AddProductTitle= "Another 4-Week";
		$ProductImage = '<img class="img-responsive center-block"src="/media/images/f4p/f4p-4-week-kit-01.jpg" alt="4 Week Food4Patriots Kit"/>';
}
//END TEST
if($_GET["upgrade"] == 1 ) {
	$isUpgrade = TRUE;
...
<div class="container oto-width">
	<div>
		<h1 class="darkRed text-center"><?php echo $firstName;?><span class="titles">, Want To Get <?php echo $AddProductTitle; ?> Kit For $50 Off? </span></h1>
	</div>
	<div style="padding-bottom:20px;"><?php echo $ProductImage; ?></div>
	<div>
		<p><?php echo $firstName;?>, once again, congratulations for making the great decision to get the <?php echo $PrevProductName; ?> Food4Patriots kit.</p>
		...
		<p>So to thank you for becoming a customer today, I am offering you an <strong>exclusive $50.00 discount (that’s 25% off)</strong> on an additional <?php echo $AddProduct; ?> kit.</p>
		<p>That’s right, you can get <?php if (JV::in("55-month")) { echo "a"; }else { echo "ONE MORE";} ?> <?php echo $AddProduct; ?> Food4Patriots kit for just $147 if you act now.</p>
		<p>Look, I want to help you get where you need to be with your food stockpile…but without breaking the bank to get there.</p>
		<p>So fellow Patriot, would you like to accelerate your results by adding an additional <?php echo $AddProduct; ?> Food4Patriots Kit to your order at a 1-time discount sale price of $147 (that’s a $50.00 discount and 25% off the already low price)?</p>
