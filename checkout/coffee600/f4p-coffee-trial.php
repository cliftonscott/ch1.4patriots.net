				...
				<div style="padding-top: 0px; padding-right:20px;">
					<div class="row">
						...
						<div class="col-lg-12 coffee-checkout">
							...
							<ul>
								<li>30 mouth-watering servings of the first-ever survival coffee packed in a special triple-layered, resealable, re-usable Mylar packet with an amazing 25-year shelf life!</li>
