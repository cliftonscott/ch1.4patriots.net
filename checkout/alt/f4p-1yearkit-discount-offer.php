...
$today = date(mktime());
$offerExpired = false;
$expiresOn = date(strtotime("07/14/2016"));
if($today >= $expiresOn) {
	$offerExpired = true;
}
...
<div id="content" style="display:block;">
	<div class="container oto-width">
		...
		<div style="margin-top:50px;">
			<p>Thank you for being a Food4Patriots customer! I hope that you love your Food4Patriots kit and have been sleeping easier at night knowing that you are more prepared for whatever may happen.</p>
			...
			<p>Would you like to accelerate your results by getting the 1-year Food4Patriots Kit at a one-time discount sale price of $1,497? (That&rsquo;s a $1500.00 discount... you&rsquo;ll get one year&rsquo;s worth of food for just $.83 per serving!)</p>
	...
	<div class="container oto-width">
		...
		<h2 class="darkRed title-max-600 center-block text-center">Get On The ‘Fast Track’ - Claim Your 1-year
			Food4Patriots Kit For $1500.00 Off Right Now!</h2>
		...
		<p>I was only able to secure a limited quantity of these 1-year Food4Patriots kits and it&rsquo;s been one of our most frequent requests,
			...
			go ahead and click the big green &ldquo;Add to Cart&rdquo; button below to add the 1-year Food4Patriots Kit to your order
			today!</p>
		...
		<p>This is your last chance for this special one-time discount, so you need to act now. To get your 1-year
