...
body {
	...
	/*background-image: url(/assets/images/video-lander/img-background-police.jpg);*/
...
<div class="container-main">
	...
	<script>
		function loadBG(){
			document.getElementById("background-img").style.backgroundImage="url(/assets/images/video-lander/img-background-police.jpg)";
		}
