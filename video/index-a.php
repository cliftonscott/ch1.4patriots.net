...
<div class="container-main">
	<div class="container">
    	<div class="row">
            ...
            <div class="col-md-12">
                <div id="videobox"> 
                   <script type="text/javascript" src="https://reboot.evsuite.com/player/UFBHLVZTTDJfVGVycm9yLUZJTkFMX1VuY29tcHJlc3NlZC5tcDQ=/?container=evp-T2QLWZ02G3"></script><div id="evp-T2QLWZ02G3" data-role="evp-video" data-evp-id="UFBHLVZTTDJfVGVycm9yLUZJTkFMX1VuY29tcHJlc3NlZC5tcDQ="></div>
            	</div>               
            <div class="col-md-12">
            	<!-- Button Stuff -->
