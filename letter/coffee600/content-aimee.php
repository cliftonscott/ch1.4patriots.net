...
<div class="container-main">
	<div class="container oto-width">
		...
		<!--<img class="img-responsive center-block margin-tb-20" style="width: 100%" src="/media/images/f4p/f4p-coffee-montage-01.jpg" alt="">-->
			...
			<h2 class="darkRed text-center">“Have You Covered All Your Bases?”</h2>
			<img src="/media/images/misc/img-coffee-packs.jpg" class="img-responsive pull-left img-padding-right media">
			...
			<div class="testimonial"><i class="fa fa-quote-left fa-2x pull-left red-quote"></i>
				<div class="testimonial-text">
					...
					-<strong> Rebecca - Bonners Ferry, ID</strong></div>
			...
			<div class="testimonial"><i class="fa fa-quote-left fa-2x pull-left red-quote"></i>
				<div class="testimonial-text">
					...
					-<strong> Robert - Titusville, FL</strong></div>
				<i class="fa fa-quote-right fa-2x pull-right red-quote-no-audio"></i></div>
			...
			<div class="testimonial"><i class="fa fa-quote-left fa-2x pull-left red-quote"></i>
				<div class="testimonial-text">
					...
					-<strong> Elizabeth - North Carolina</strong></div>
				<i class="fa fa-quote-right fa-2x pull-right red-quote-no-audio"></i></div>
			...
			<div class="outLineBoxDarkBlueCoffee" style="min-height:240px;">
				<div>
					<img src="/media/images/misc/seal-guarantee-money.jpg" alt="Guarantee #2" class="pull-left img-responsive media" style="padding-right:10px;">
	...
	<div style="margin-top: -200px" class="container oto-width">
